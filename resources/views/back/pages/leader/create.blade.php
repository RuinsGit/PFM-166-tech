        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('back.pages.leaders.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="position_az" name="position_az" value="{{ old('position_az') }}" required>
                                        @error('position_az')
                                        <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="position_ru" name="position_ru" value="{{ old('position_ru') }}">
                                        @error('position_ru')
                                        <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
