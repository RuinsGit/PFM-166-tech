        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('back.pages.vacation.store') }}" method="POST">
                                @csrf
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="email_text" class="form-control @error('email_text') is-invalid @enderror" required></textarea>
                                    @error('email_text')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date" name="application_deadline" class="form-control @error('application_deadline') is-invalid @enderror" required>
