        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Yeni Qəbul</h4>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('back.pages.acceptance.store') }}" method="POST">
                                @csrf
                                ...
                                <div class="tab-content" id="myTabContent">
                                    ...
                                    <div class="tab-pane fade show active" id="az" role="tabpanel" aria-labelledby="az-tab">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea name="text_az" class="form-control @error('text_az') is-invalid @enderror" required></textarea>
                                            @error('text_az')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="tab-pane fade" id="en" role="tabpanel" aria-labelledby="en-tab">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea name="text_en" class="form-control @error('text_en') is-invalid @enderror" required></textarea>
                                            @error('text_en')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="tab-pane fade" id="ru" role="tabpanel" aria-labelledby="ru-tab">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea name="text_ru" class="form-control @error('text_ru') is-invalid @enderror" required></textarea>
                                            @error('text_ru')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
